...
class OtpForgetPasswordVerificationScreen extends StatefulWidget {
  @override
  _OtpForgetPasswordVerificationScreenState createState() =>
      _OtpForgetPasswordVerificationScreenState();
}

class _OtpForgetPasswordVerificationScreenState
    extends State<OtpForgetPasswordVerificationScreen> {
  ...
  Future<void> resendOtp() async {
    ...
    if (response.statusCode == 200) {
      ...
      XToastr.show(context, "OTP has been sent succussfuly!", "success");
    } else {
      // Handle error
      setState(() {
        isResending = false; // Reset resending status
  ...
  Future<void> verifyOtp() async {
    ...
    if (response.statusCode == 200) {
      ...
      // Handle error
      XToastr.show(
          context, 'Invalid or expired OTP. Please try again.', "error");
    }
    setState(() {
      _isLoading = false;
    });

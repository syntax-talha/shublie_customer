...
const String url = 'http://192.168.100.5';
const String apiUrl = '${url}:8000/api';
const String baseUrl = '${url}:8000';
const String chatUrl = '${url}:3000';

const MapsApiKey = 'AIzaSyATEkwKdwP-qL4YREEXJNhoxlHrNRiDC14';
const APP_NAME = 'Handyman Service';
const APP_NAME_TAG_LINE = 'On-Demand Home Services App';
var defaultPrimaryColor = Color(0xFFEA5D25); // Color(0xFF5F60B9);#EA5D25
